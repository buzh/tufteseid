...
| W / S | walk the active ground's dataset ring — under LiDAR the national mosaic is the first stop, then one per cached acquisition on screen, then the viewport's acquisitions | — |
